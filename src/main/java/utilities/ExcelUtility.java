...
public class ExcelUtility {
	...
	public void fillGreenColor(String sheetName, int rownum, int colunm) throws IOException{
		fi = new FileInputStream(path);
		workbook = new XSSFWorkbook(fi);
		sheet = workbook.getSheet(sheetName);
	...
	public void fillRedColor(String sheetName, int rownum, int colunm) throws IOException{
		fi = new FileInputStream(path);
		workbook = new XSSFWorkbook(fi);
		sheet = workbook.getSheet(sheetName);
